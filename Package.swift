...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.5.0.2/PAGAdSDK.xcframework.zip",
                      checksum: "ef3ccb03320b3e54083b805f33e73e497522d6cb7e352708c4220cbd8348f839"),
