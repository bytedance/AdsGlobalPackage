...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.3.0.4/PAGAdSDK.xcframework.zip",
                      checksum: "0e476798e9baef3b2f1cabeb2b8d92289bc6cd34da2fafb8a3b01f717ff3e32c"),
