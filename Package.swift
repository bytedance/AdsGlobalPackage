...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.4.0.4/PAGAdSDK.xcframework.zip",
                      checksum: "805a3f8f0781297090cb2de26f4f72af9ebc3dbac981c8bc912034f4fe8d8df0"),
