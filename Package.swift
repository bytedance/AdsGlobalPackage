...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.3.0.3/PAGAdSDK.xcframework.zip",
                      checksum: "d708355a7a33e6e785c7ec58376943b051565095d64320de42b80f869834b633"),
