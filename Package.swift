...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.2.0.9/PAGAdSDK.xcframework.zip",
                      checksum: "d0c5a98f51607798adfb7c98ed6e97ff6054c5db7da7e46ac86037603a2852a8"),
