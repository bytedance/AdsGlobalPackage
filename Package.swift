...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.4.0.8/PAGAdSDK.xcframework.zip",
                      checksum: "ad0308a0dd4c5b50ebd9f3d99f716bc185f75328038ce1b816d63bac6b8e7b00"),
