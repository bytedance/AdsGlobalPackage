...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.2.0.7/PAGAdSDK.xcframework.zip",
                      checksum: "a7280ec6b678ed01a9013ecdb7bf2ff89d9e25b713d50980194bd610b29fbc9a"),
