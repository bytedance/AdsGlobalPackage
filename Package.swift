...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.2.0.6/PAGAdSDK.xcframework.zip",
                      checksum: "b86b7f65e6a15e562191ff905aace12e21f27f6f1baaa81f281f119a33adfe0b"),
