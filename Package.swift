...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "PAGAdSDK",
                      url:"https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/5.5.0.0/PAGAdSDK.xcframework.zip",
                      checksum: "812ca5261aefa31883175c81da248939d9f0f00181d4271e4f4db41d7c6e6d6a"),
